        ...
        try:
            ...
            async with self.update_lock:
                ...
                if username == self.last_user:
                    ...
                    await self.send_to_overlay(f"COUNT:0:{username}")
                    return
                ...
                if number == self.expected_number:
                    ...
                    # Send update to overlay with username
                    await self.send_to_overlay(f"COUNT:{self.current_count}:{username}")
                else:
                    ...
                    # Send reset to overlay with username
                    await self.send_to_overlay(f"COUNT:0:{username}")
